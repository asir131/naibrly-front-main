    ...
    <div className="fixed inset-0 backdrop-blur-lg flex justify-center items-center z-50">
      <div className="bg-white flex rounded-[12px] max-w-[680px] relative">
        ...
        <div className="flex-1">
          <Image
            src={Images.modal_img}
            alt="user"
            width={297}
            className="rounded-bl-[12px] rounded-tl-[12px] h-full"
          />
        </div>
        <div className="modal   ">
          <div>
            <h1 className="text-[18px] text-[#000] font-medium">
              Window Washing
            </h1>
          ...
          <div className="mt-3 flex flex-col items-center gap-4 border-b pb-4">
            <div className="flex items-center gap-2">
              <div>
                <Image
                  className="rounded-[6px] w-10 h-10"
                  src={Images.left1}
                  quality={75}
                  priority
                  alt=""
              ...
              <div className="flex flex-col gap-[6px]">
                <span className="text-sm font-semibold">Moniru</span>
          ...
          {/* Total Benefits */}
          <div className="">
            <h3 className="text-[#000] text-[16px] font-medium">
              Total Benefits:
            </h3>
          ...
          <div className="flex justify-between items-center gap-[45px]">
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2">
                <div className="text-[#F34F4F] text-[16px] font-semibold">
                  $68/hr
                </div>
        ...
        <div className="flex justify-between items-center mt-[138px] mb-[73px] w-full gap-[54px]">
          ...
          <div className="flex-1 flex flex-col gap-[44px]">
            <h1 className="userHero_head">
              ...
              <span className="text-[38px] font-semibold text-[#0E7A60]">
                Naibrly
              </span>
              .
            </h1>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="input_submit cursor-pointer">
                ...
                <button className="text-[16px] font-semibold text-white cursor-pointer">
                  Find in your area
                </button>
              </div>
            </div>
      ...
      <div className="px-[126px] flex flex-col gap-7 mt-[46px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6">
          {bundlesData.map((bundle) => {
            return (
              <div key={bundle.id} className="bundle_card">
                ...
                <div className="flex justify-between items-center w-full">
                  <div className="flex items-center gap-2">
                    <span className="text-[#F34F4F] text-[16px] font-semibold">
                      $68/hr
                    </span>
                    <span className="text-[#000] text-[16px] font-semibold">
                      $55/hr
                    </span>
                    <span className="text-[#0E7A60] text-[16px] font-semibold">
                      -$13
                    </span>
                  </div>
                  ...
                  >
                    <button className="bundle_view text-[18px] text-[#0E7A60]">
                      View details
                    </button>
                  </div>
                </div>
        ...
        <div className="flex justify-center items-center ">
          <button className="view_all text-2xl text-[#0E7A60] font-medium">
            view_all
          </button>
        </div>
      </div>
...
const FindArea = () => {
  return (
    <Suspense
      fallback={<div className="w-full px-[126px] py-20">Loading...</div>}
    >
      <FindAreaContent />
    </Suspense>
  );
