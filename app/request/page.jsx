            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-2">
              ...
              <div className="flex items-center gap-2">
                ...
                {isBundle && (
                  ...
                  <span className="hidden sm:inline-flex px-2 py-1 bg-purple-100 text-purple-700 text-xs font-medium rounded">
              ...
              <div className="flex flex-col items-start sm:items-end gap-2">
                ...
                <span
                  ...
                  className={`px-3 py-1 rounded-full text-xs font-medium ${request.statusBg} ${request.statusColor} whitespace-nowrap`}
                ...
                {isBundle && (
                  ...
                  <span className="inline-flex sm:hidden px-2 py-1 bg-purple-100 text-purple-700 text-xs font-medium rounded">
