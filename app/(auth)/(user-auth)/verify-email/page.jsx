...
function VerifyEmailContent() {
  ...
  const [verifyEmailOtp, { isLoading }] = useVerifyEmailVerificationOtpMutation();
  ...
  const handleConfirm = async (event) => {
    ...
    try {
      ...
      if (typeof window !== 'undefined') {
        ...
        if (!pendingRaw) {
          setTimeout(() => router.push('/create-account'), 1000);
          return;
        }
        ...
        login({ user: pending.user, userType: pending.userType });
