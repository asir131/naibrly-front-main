...
export default function UserInfo() {
    ...
    return (
        <div className="">
            <form onSubmit={handleSubmit} className="w-[90%] mx-auto user_info_input md:px-[200px] md:py-[50px] overflow-x-hidden">
                ...
                <div className='flex items-center justify-center'>
                    <div className='w-full md:w-[353px]'>
                            ...
                            >
                                {businessLogo ? (
                                    <div className='absolute inset-0 flex flex-col items-center justify-center bg-green-50'>
                                        ...
                                        <p className="text-sm text-green-700 font-medium">{businessLogo.name}</p>
                                    ...
                                    <div className='absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 flex flex-col items-center gap-2'>
                                        <div className='p-3 bg-gray-100 rounded-full group-hover:bg-green-50 transition-colors'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 20 22" fill="none">
                                                ...
                                                <path d="M8.75 4.75L0.75 4.75M4.75 0.75V8.75" stroke="#1C5941" strokeWidth="1.5" strokeLinecap="round" />
                                            </svg>
                                        </div>
                                        <label className="block text-black text-sm font-semibold">Upload Your Business Logo</label>
                        ...
                        <div className="mb-4 relative">
                            <label className="text-[#1C5941] text-[10px] font-semibold absolute left-4 -top-1.5 bg-white px-1">Business Name (AS REGISTERED) *</label>
                            <input
                                type="text"
                                name="businessName"
                                ...
                                required
                            />
                            <p className="text-xs text-gray-500 mt-1 ml-1">Official name as it appears on legal documents</p>
                        </div>

                        <div className="mb-4 relative">
                            <label className="text-[#1C5941] text-[10px] font-semibold absolute left-4 -top-1.5 bg-white px-1">Business Name (DBA)</label>
                            <input
                                type="text"
                            ...
                            />
                            <p className="text-xs text-gray-500 mt-1 ml-1">Optional - Name used for marketing and branding</p>
                        </div>
                        <div className="mb-4 relative">
                            <label className="text-[#1C5941] text-[10px] font-semibold absolute left-4 -top-1.5 bg-white px-1">Email Address *</label>
                            <input
                                type="email"
                                name="businessEmail"
                        ...
                        <div className="mb-4 relative">
                            <label className="text-[#1C5941] text-[10px] font-semibold absolute left-4 -top-1.5 bg-white px-1">Password *</label>
                            <input
                                type="password"
                                name="password"
                        ...
                        <div className="mb-4 relative">
                            <label className="text-[#1C5941] text-[10px] font-semibold absolute left-4 -top-1.5 bg-white px-1">Confirm Password *</label>
                            <input
                                type="password"
