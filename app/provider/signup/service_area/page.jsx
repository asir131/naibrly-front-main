...
const ServiceArea = () => {
  ...
  const [updateProviderZipCode, { isLoading }] =
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.error(
        error?.data?.message ||
          error?.message ||
          "Failed to update service area. Please try again."
      );
    }
  };
  return (
              ...
              <div>
                ...
                <div className="bg-blue-50 border-l-4 border-blue-400 p-3 mb-4">
                  <p className="text-blue-700 text-sm flex items-start gap-2">
                    ...
                    <span>
                      Enter the zip codes where you provide services. You can
                      add multiple locations.
                    </span>
                  </p>
                </div>
                <div className="relative w-full   focus:border-[#1C5941] transition-colors">
                  <RiSearch2Line className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-xl pointer-events-none" />

                  <input
                    className="input_box !pl-12 text-[16px] text-[#333]"
                    type="text"
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 bg-[#1C5941] text-white px-4 py-2 rounded-md hover:bg-[#154432] transition-colors text-sm font-medium"
                  >
                    Add
                  </button>
                </div>
