        ...
        <div className="flex flex-col items-start w-full md:w-[353px]">
          ...
          <div className="w-full">
            <div className="flex flex-col gap-2 pb-3">
              ...
              <p className="text-[#718096] text-[10px]">
                An Employer Identification Number (EIN) is a federal tax ID for
                Businesses
              </p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="pb-2 flex flex-col gap-2 relative">
                {watchedFile && watchedFile.name ? (
                  <p className="text-xs text-green-600 absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 flex flex-col items-center">
                    Uploaded: {watchedFile.name}
                  </p>
                ) : (
                  <div
                    className="absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 flex flex-col items-center gap-2"
                    onClick={handleClick}
                  >
                    <span>
                      <svg
                    ...
                    <label className="block text-black text-sm whitespace-nowrap">
